...
public class DBpediaMappingsLoaderStepDialog extends BaseStepDialog implements StepDialogInterface {
	...
	private DBpediaMappingsLoaderStepMeta meta;
	private SwtHelper swthlp;
	private String dialogTitle;
	
	public DBpediaMappingsLoaderStepDialog(Shell parent, Object stepMeta, TransMeta transMeta, String stepname) {
		super(parent, (BaseStepMeta) stepMeta, transMeta, stepname);

		meta = (DBpediaMappingsLoaderStepMeta) baseStepMeta;
		swthlp = new SwtHelper(transMeta, this.props);
		
		//dialogTitle = BaseMessages.getString(PKG, "Step.Title");
		dialogTitle = "Carregador dos mapeamentos na Base local";
	}
