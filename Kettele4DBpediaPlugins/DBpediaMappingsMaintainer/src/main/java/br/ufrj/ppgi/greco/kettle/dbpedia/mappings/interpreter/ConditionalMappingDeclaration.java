...
public class ConditionalMappingDeclaration extends Declaration {
	
	//private HashMap<String, Object> parametersValues;
	
	
	public ConditionalMappingDeclaration(String term){
		this.term=term;
	...
	public TemplateMapping generatePropertiesMapping(Template template, TemplateMapping templateMapping, String parameter) {
		...
		//defaultMappings
		//Lista de declarações, que sao PropertyMappingDeclaration
