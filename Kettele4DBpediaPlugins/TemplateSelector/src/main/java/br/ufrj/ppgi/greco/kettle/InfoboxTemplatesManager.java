...
public static String[] getAttributes(){
		...
		String[] infobox_attributes={"nome_oficial","nome_nativo",
				"outro_nome","país","apelido", "lema",
				"tamanho_imagens","fuso_horário_DST",
				"diferença_utc_DST","coord_título","coord_sufixo",
