package org.ufrj.ppgi.greco.kettle.dbpedia.templates;
	...
	public List<TemplateCandidate> selectTemplateCandidates(String[] words){
		...
		for (CandidateClass c: lista){
			...
			if(classTemplates==null){
				...
				//System.out.println("CLASSE "+c.getClassname()+" NAO TEM TEMPLATES ASSOCIADOS ...");
				
				continue;
			}
			
			System.out.println("CLASSE "+c.getClassname()+"TEM TEMPLATES ASSOCIADOS ...");
			
			System.out.println(" QDE TEMPLATES ="+classTemplates.size());
